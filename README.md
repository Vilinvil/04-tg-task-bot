Для запуска своей версии бота через ngrok создайте tg бота и запустите прокси сервер на localhost:8081. 
Затем создайте config.json c содержимым:
{
"TelegramBotToken": "Токен вашего бота внутри кавычек",
"WebhookURL": "адрес с которого ngrok проксирует на http://localhost:8081"
}
